...
namespace OnlineShop.Areas.Admin.Controllers
{
	...
	public class CommentController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Email,CommentText,ProductId,CreatedDate")] Comment comment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Email,CommentText,ProductId,CreatedDate")] Comment comment)
        {
            if (id != comment.Id)
            {
                return NotFound();
